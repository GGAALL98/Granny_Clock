...
class MedicationReminderApp(QWidget):
    def __init__(self, language="en"):
        ...
        self.translations = load_translations()  # Load translations5
    ...
    def init_ui(self):
        ...
        layout.addLayout(top_left_layout)  # Add the button to the layout
        layout.addLayout(top_layout)  # Add time/date below the button

        # Divider Line (After Time and Date)
